            ...
            <div className='loginBg' style={{minHeight:"100vh"}}>
                <Narrow>
                    <div className='flex text-white flex-col pt-24 max-xl:pt-5 items-center'>
                        ...
                        <div className='my-3 text-lg'><Link to="/">Home</Link> &nbsp;{">"}&nbsp;<span className='font-semibold'>Sign Up</span> </div>
                        <div className='my-5 bg-white text-black w-6/12 max-xl:w-full rounded-md p-12 max-xl:p-5'>
                            ...
                            <div className='text-gray-500 my-2'>Create an account today and start using Quad.</div>
                            <form className='mt-10 mb-5'>
                                <div className='text-xl my-2 font-bold'><label htmlFor='name'>Name</label></div>
                                <div className='text-xl my-2'><input className='w-full bg-[#F8F4FF] p-3 rounded-full' type='text' id='text' name="text" placeholder='Your Name' /></div>
                                <div className='text-xl mt-5 mb-2 font-bold'><label htmlFor='email'>Email</label></div>
                                ...
                                <button type='submit' className='my-5 bg-customPurple w-full p-3 rounded-full text-xl text-white'>Create Your Account</button>
                            </form>
                            <div className='text-center'>I have read and agree to the <span className=' text-customPurple underline font-semibold'>Terms & Conditions</span> </div>
